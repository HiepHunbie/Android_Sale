...
public class DataEntrySales implements Serializable {
    @SerializedName("mobileLoanAmount")
    @Expose
    private int mobileLoanAmount;

    public int getMobileLoanAmount() { return this.mobileLoanAmount; }

    public void setMobileLoanAmount(int mobileLoanAmount) { this.mobileLoanAmount = mobileLoanAmount; }
    @SerializedName("lstProductJson")
    @Expose
    private String lstProductJson;

    public String getLstProductJson() { return this.lstProductJson; }

    public void setLstProductJson(String lstProductJson) { this.lstProductJson = lstProductJson; }
    ...
    public int getIsSync() { return this.isSync; }

    public void setIsSync(int isSync) { this.isSync = isSync; }
    ...
    @Expose
    private long mobileIssueDateCitizen;

    public long getMobileIssueDateCitizen() { return this.mobileIssueDateCitizen; }

    public void setMobileIssueDateCitizen(long mobileIssueDateCitizen) { this.mobileIssueDateCitizen = mobileIssueDateCitizen; }
    ...
    @Expose
    private int mobileHasInsurrance;

    public int getMobileHasInsurrance() { return this.mobileHasInsurrance; }

    public void setMobileHasInsurrance(int mobileHasInsurrance) { this.mobileHasInsurrance = mobileHasInsurrance; }
    @SerializedName("id")
    @Expose
    private int id;
    ...
    @SerializedName("mobileCatResultType")
    @Expose
    private String mobileCatResultType;

    public String getMobileCatResultType() { return this.mobileCatResultType; }

    public void setMobileCatResultType(String mobileCatResultType) { this.mobileCatResultType = mobileCatResultType; }
    ...
    @SerializedName("mobileCatResultCompanyName")
    @Expose
    private String mobileCatResultCompanyName;

    public String getMobileCatResultCompanyName() { return this.mobileCatResultCompanyName; }

    public void setMobileCatResultCompanyName(String mobileCatResultCompanyName) { this.mobileCatResultCompanyName = mobileCatResultCompanyName; }
    ...
    @Expose
    private int mobileLoanTenor;

    public int getMobileLoanTenor() { return this.mobileLoanTenor; }

    public void setMobileLoanTenor(int mobileLoanTenor) { this.mobileLoanTenor = mobileLoanTenor; }
    @SerializedName("mobileCompanyTaxNumber")
    @Expose
    private String mobileCompanyTaxNumber;

    public String getMobileCompanyTaxNumber() { return this.mobileCompanyTaxNumber; }

    public void setMobileCompanyTaxNumber(String mobileCompanyTaxNumber) { this.mobileCompanyTaxNumber = mobileCompanyTaxNumber; }
    @SerializedName("appStatus")
    @Expose
    private int appStatus;

    public int getAppStatus() { return this.appStatus; }
    ...
    @SerializedName("mobileSignContracAddress")
    @Expose
    private String mobileSignContracAddress;

    public String getMobileSignContracAddress() { return this.mobileSignContracAddress; }

    public void setMobileSignContracAddress(String mobileSignContracAddress) { this.mobileSignContracAddress = mobileSignContracAddress; }
    ...
    @SerializedName("mobileSignContracAt")
    @Expose
    private String mobileSignContracAt;

    public String getMobileSignContracAt() { return this.mobileSignContracAt; }

    public void setMobileSignContracAt(String mobileSignContracAt) { this.mobileSignContracAt = mobileSignContracAt; }
    ...
    public String getUserRoute() { return this.userRoute; }

    public void setUserRoute(String userRoute) { this.userRoute = userRoute; }
